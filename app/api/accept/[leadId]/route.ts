...
type RecommendationResult = Awaited<
  ReturnType<typeof crossSellEngine.recommendForLead>
>;

type ProposalResult = Awaited<
  ReturnType<typeof crossSellEngine.generateBundleProposal>
>;
...
): Promise<NextResponse<ApiSuccess<RecommendationResult> | ApiError>> {
  try {
...
export async function POST(
  req: NextRequest,
  context: RouteContext
): Promise<NextResponse<ApiSuccess<ProposalResult> | ApiError>> {
  try {
    const { leadId } = await context.params;
